function []= f_make_figures(tau)
   ts = windowSizeResults1{1, tau};
   SWd = windowSizeResults1{2, tau};
   Md = windowSizeResults1{3, tau};
   IsSliding2 = windowSizeResults1{4, tau};
   IsSliding3 = windowSizeResults1{5, tau};
